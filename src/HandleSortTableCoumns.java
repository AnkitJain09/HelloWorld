...
public class HandleSortTableCoumns {
	...
	public static void main(String[] args) {
		...
		//Go through the lecture 105 - 108 of Selenium webdriver with java - basics to advanced+frameworks of Rahul Shetty Udemy course.
